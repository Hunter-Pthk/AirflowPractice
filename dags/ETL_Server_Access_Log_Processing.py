...
extract_file = '/opt/airflow/data/extracted-data.txt'
transform_file = '/opt/airflow/data/transformed.txt'
load_file = '/opt/airflow/data/capitalized.txt'
...
default_args = {
    ...
    'email' : ['nikeshpathak461@gmail.com'],
    'retries' : 1,
